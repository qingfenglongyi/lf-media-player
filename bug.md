...
标题要居中显示，占界面宽度的2/3。如果文字太长，则水平滚动，从右到向左滚动
隐藏播放列表和歌曲库里的“已选择0首”，只有在显示复选框时才显示。

- 【已修复】歌词显示乱码 - 改进编码检测，优先排除乱码字符
- 【已修复】歌曲结束后没有继续播放 - STATE_ENDED时自动调用playNext()
- 【待分析】创建歌单失败
- 【待分析】列表里的 菜单没有图标，改成文字菜单，显示"操作"字样
